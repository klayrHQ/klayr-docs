...
:page-toclevels: 4
// Project URLs
:url_guides_setup_init: ROOT::build-blockchain/create-blockchain-client.adoc#bootstrapping-a-new-blockchain-client-with-klayr.xyzmander
...
NOTE: The client CLI is available out of the box, if the blockhain client was xref:{url_guides_setup_init}[initialized with Klayr Commander].
...
Genesis block files saved at: /Users/xyz/Documents/GitHub/klayr-sdk/examples/dpos-mainchain/Users/xyz/Lightcurve-Code
----
====
...
? Please enter: recipientAddress:  klyzot8pzdcvjhpjwrhq3dkkbf499ok7mhwkrvsq3
