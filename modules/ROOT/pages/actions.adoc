...
// Project URLs
:url_general_endpoints: {docs_general}api/klayr-node-rpc.adoc
...
== Module- and plugin-specific actions

Modules and plugins often expose additional actions to the application.
