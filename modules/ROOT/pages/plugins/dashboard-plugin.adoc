...
`@klayrhq/klayr-framework-dashboard-plugin` is a plugin for the xref:{url_klayr_framework}[Klayr Framework] that provides a user interface which enables developers to conveniently view and communicate with the blockchain application during the development.
...
const { DashboardPlugin } = require('@klayrhq/klayr-framework-dashboard-plugin');
