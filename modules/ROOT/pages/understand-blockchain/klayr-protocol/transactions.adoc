...
:url_transactions_unlock: {url_protocol}transactions.adoc#unlock-vote
...
image::protocol/baseTransaction.svg[TxDiagram]
...
image::protocol/balanceTransferAsset.svg[BalanceTDiagram]
...
image::protocol/delegateRegAsset.svg[DelegateDiagram]
...
image::protocol/voteAsset.svg[VoteDiagram]
...
image::protocol/unlockVoteAsset.svg[UnlockVoteDiagram]
...
image::protocol/multisigRegAsset.svg[MultisigDiagram]
...
image::protocol/pomAsset.svg[PoMDiagram]
