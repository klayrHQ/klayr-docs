...
// Project URLs
:url_sdkv5_rpc_events: {docs-klayr-v5}events.adoc
...
*Module events in Klayr SDK v5 follow the {url_wiki_pubsub}[publish-subscribe-pattern^].*
...
|Retrieving
a|
In Klayr SDK v5, events could be subscribed directly via the API client.
