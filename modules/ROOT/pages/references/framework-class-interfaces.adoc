...
:description: Covers references of the Klayr Framework, like the BaseModule, the BaseAsset and the BasePlugin.
:toc: preamble
:imagesdir: ../../assets/images
:page-no-next: true
:page-previous: /klayr-sdk/references/klayr-elements/index.html
...
Schema is a type defined by codec, which is a Klayr JSON schema.
