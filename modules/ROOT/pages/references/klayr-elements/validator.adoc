= Validator
:description: This section contains the installation, updates and usage for the Klayr validator.
:toc:
:v_protocol: master
:url_klayr_protocol: klayr-v3@ROOT::understand-blockchain/klayr-protocol/index.adoc
:url_semver: https://semver.org/

The @klayrhq/klayr-validator package is a wrapper of validation packages.
It includes custom validations utilities related to the xref:{url_klayr_protocol}[Klayr Protocol].
...
[source,js]
----
const validator = require('@klayrhq/klayr-validator');
