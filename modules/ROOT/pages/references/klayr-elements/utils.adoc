...
@klayrhq/klayr-utils is a library providing various utilities for handling data structures, objects, and jobs.

== Installation

[source,bash]
----
npm install @klayrhq/klayr-utils
----
...
[source,bash]
----
npm update @klayrhq/klayr-utils
----
