...
:description: Technical references regarding the genesis package of Klayr Elements.
:toc:

`@klayrhq/klayr-genesis` is a package which contains genesis block creation functions in accordance with the Klayr protocol.
...
[source,bash]
----
npm update @klayrhq/klayr-genesis
----
...
[source,js]
----
const { TokenModule, DPoSModule, genesis, configDevnet } = require('klayr-sdk');
