...
The @klayr/transaction-pool package collects, verifies, and provides transactions to the forger module in order to produce a block.
...
[source,bash]
----
npm install @klayr/transaction-pool
----
...
[source,bash]
----
npm update @klayr/transaction-pool
----
...
[source,js]
----
const transactionPool = require('@klayr/transaction-pool')
