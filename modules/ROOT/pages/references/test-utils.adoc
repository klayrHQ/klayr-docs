= The Klayr SDK testing utilities
:toc: preamble
// URLs
:url_github_statestor_mock: https://github.com/KlayrHQ/klayr-sdk/blob/v5.2.1/elements/klayr-chain/src/testing/mocks/state_store_mock.ts
:url_github_app_env: https://github.com/KlayrHQ/klayr-sdk/blob/v5.2.1/framework/src/testing/app_env.ts

A detailed reference of the available test utilities in the Klayr SDK test suite.
...
* MockInput(object): Input data for the state store mock, (this is optional).
...
* opts(object): Input data for the data access mock, (this is optional).
...
* header: Block header.
* skipSignature(boolean): signature will be skipped if set to `true`, (this is optional).
...
* header: Block header partial, (this is optional).
