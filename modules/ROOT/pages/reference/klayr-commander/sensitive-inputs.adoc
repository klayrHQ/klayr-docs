...
:description: The sensitive inputs page describes the different methods of how to provide sensitive data such as passphrases to the Klayr Commander.
:toc:
...
[source,bash]
----
$ klayr transaction:create --type=0 100 9397838105554816361L --second-passphrase prompt
Please enter your secret passphrase: ****************************************************************
Please re-enter your secret passphrase: ****************************************************************
