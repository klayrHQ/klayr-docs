...
:description: Technical references regarding the Nodes endpoints of the API client package of Klayr Elements. This consists of usage examples, available parameters and example responses.
:toc:
:v_core: 3.0.0
:url_klayr_core_api: {v_core}@klayr-core::reference/api.adoc

This is a resource for interacting with the `node` endpoint provided by the Klayr public API.
...
For example, the Klayr epoch time and version.
