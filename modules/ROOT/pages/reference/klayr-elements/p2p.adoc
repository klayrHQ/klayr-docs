...
- [Connect to Klayr networks](examples/klayr-networks): Example to create a lightweight p2p client that can connect to klayr networks like [testnet](examples/klayr-networks/connect_to_testnet.ts), [mainnet](examples/klayr-networks/connect_to_mainnet.ts) and [devnet](examples/klayr-networks/connect_to_devnet.ts) and listen to various events and request data on connect event.
