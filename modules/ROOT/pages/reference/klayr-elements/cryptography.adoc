...
:description: Technical references regarding the cryptography packages of Klayr elements. This consists of usage examples, available options and example responses.
:toc:
...
The Klayr elements cryptography module provides all the cryptographic functionality necessary when interacting with the Klayr ecosystem.
...
`string`: This is the Klayr address for the public key.
