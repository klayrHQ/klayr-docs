...
:description: Technical references regarding the passphrase package of Klayr elements. This consists of usage examples, available options and example responses.
:toc:
:url_npm_bip39: https://www.npmjs.com/package/bip39

The Klayr elements passphrase package provides tools for generating and validating mnemonic passphrases.
