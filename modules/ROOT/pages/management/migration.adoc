...
:url_klayr_blog_migration: https://klayr.xyz/blog/development/announcing-klayr-testnet-v3-migration
:url_klayr_blog_migration_mainnet: https://klayr.xyz/blog/development/announcing-klayr-mainnet-v3-migration
// Project URLs
