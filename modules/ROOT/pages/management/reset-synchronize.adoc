...
:toc:
// Project URLs
:url_klayr_snapshots: https://snapshots.klayr.com
:url_klayr_snapshots_testnet: https://snapshots.klayr.com/testnet/
:url_klayr_snapshots_mainnet: https://snapshots.klayr.com/mainnet/
