...
:url_github_srs_module: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_module/index.js
:url_github_srs_schemas: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_module/schemas.js
:url_github_srs_constants: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_module/constants.js
:url_github_srs_create_asset: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_module/assets/create_recovery.js
:url_github_srs_initiate_asset: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_module/assets/initiate_recovery.js
:url_github_srs_vouch_asset: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_module/assets/vouch_recovery.js
:url_github_srs_claim_asset: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_module/assets/claim_recovery.js
:url_github_srs_close_asset: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_module/assets/close_recovery.js
:url_github_srs_remove_asset: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_module/assets/remove_recovery.js
:url_github_srs_transfer: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_api_plugin/controllers/transfer_token_api.js
:url_github_srs_create: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_api_plugin/controllers/create_recovery_api.js
:url_github_srs_initiate: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_api_plugin/controllers/initiate_recovery_api.js
:url_github_srs_vouch: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_api_plugin/controllers/vouch_recovery_api.js
:url_github_srs_claim: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_api_plugin/controllers/claim_recovery_api.js
:url_github_srs_close: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_api_plugin/controllers/close_recovery_api.js
:url_github_srs_remove: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/blockchain_app/srs_api_plugin/controllers/remove_recovery_api.js
:url_github_srs_component_home: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/home.js
:url_github_srs_component_create: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/createRecovery.js
:url_github_srs_component_initiate: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/initiateRecovery.js
:url_github_srs_component_vouch: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/vouchRecovery.js
:url_github_srs_component_claim: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/claimRecovery.js
:url_github_srs_component_close: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/closeRecovery.js
:url_github_srs_component_remove: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/removeRecovery.js
:url_github_srs_component_account: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/getAccount.js
:url_github_srs_component_node: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/getNodeInfo.js
:url_github_srs_component_recoveryconfigs: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/getRecoveryAccounts.js
:url_github_srs_component_sidemenu: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/sideMenu.js
:url_github_srs_component_manager: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/social-recovery/frontend_app/src/components/recoveryManager.js
:url_react_docs: https://reactjs.org/docs/getting-started.html
// Project URLs
:url_references_schemas: understand-blockchain/codec-schema.adoc
:url_statestore: 6.0.0@klayr-sdk::reference/klayr-elements/chain.adoc#state-store
:url_references_token_module: 6.0.0@klayr-sdk::reference/klayr-framework/token-module.adoc
...
First, create the folder for the blockchain application, initialize a new Node.js ptoject and install the xref:{url_klayr_sdk}[Klayr SDK] as dependency.
...
[source,js]
----
const { BaseAsset } = require("klayr-sdk");
...
[source,js]
----
const { BaseAsset, transactions } = require('klayr-sdk');
const { createRecoverySchema } = require('../schemas');
...
class CreateRecoveryAsset extends BaseAsset {
    ...
    async apply({
        ...
        const deposit = BigInt(BASE_RECOVERY_DEPOSIT) + BigInt(transactions.convertKLYToBeddows((sender.srs.config.friends.length * FRIEND_FACTOR_FEE).toString()));
...
NOTE: Module ID until 1000 is reserved by Klayr SDK for future default modules.
...
[source,js]
----
const { BaseModule, codec } = require('klayr-sdk');
const CreateRecoveryAsset = require('./assets/create_recovery');
const ClaimRecoveryAsset = require('./assets/claim_recovery');
const InitiateRecoveryAsset = require('./assets/initiate_recovery');
const VouchRecoveryAsset = require('./assets/vouch_recovery');
...
[source,js]
----
const { BasePlugin } = require('klayr-sdk');
...
`getDBInstance()`::
Returns a key-value store for the plugin data, which is stored under the path `~/.klayr/srs-app/plugins/data/srs_data_plugin.db`.
...
[source,js]
----
const { BasePlugin, db, codec } = require('klayr-sdk');
const pJSON = require('../../package.json');
...
const getDBInstance = async (dataPath = '~/.klayr/srs-app/', dbName = 'srs_data_plugin.db') => {
...
[source,js]
----
const { transactions, cryptography } = require('@klayrhq/klayr-client');
const { createRecoverySchema } = require('../schemas');
...
This tutorial predominantly covers and explains how to build with the Klayr SDK, therefore other parts of the frontend app are not explained in great detail.
More information about how to build a React application can be found in the {url_react_docs}[official React documentation^].

For convenience, clone the development branch from the `klayr-sdk-examples` GitHub repository and use the prepared SRS `frontend_app` from the Klayr SDK examples.

.srs/
[source,bash]
----
git clone https://github.com/KlayrHQ/klayr-sdk-examples.git
mv klayr-sdk-examples/tutorials/social-recovery/frontend_app frontend_app
rm -r ./klayr-sdk-examples
cd frontend_app
npm i
----
...
====
To reset the database of the application, remove the `./klayr/` folder, which can normally be found in the home directory of the user:
...
address:
klytrqfj84n34tn97vraaq2ztmrgwgwakmqyskqw4
address (hex string):
...
address:
kly32gnhxjs887bqmgoz6y6ozh6c4c6ztpz7wjfa9
address (hex string):
...
address:
klyb6bufqcbrwvgkzuu5wqu6wnruz7awvhxwfkonb
address (hex string):
...
address:
klyomdmvwhb9r3sgj3ryp4fsqnzfn8c8twzkecugt
address (hex string):
...
[source,js]
----
import { apiClient } from '@klayrhq/klayr-client';
...
The following exercises might be interesting to get more familiar with the Klayr SDK.
