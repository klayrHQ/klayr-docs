...
[source,bash]
----
curl -o klayr-core.tar.gz https://downloads.klayr.com/klayr/mainnet/3.1.1/klayr-core-v3.1.1-linux-x64.tar.gz
----
...
[source,bash]
----
curl -o klayr-core.tar.gz https://downloads.klayr.com/klayr/mainnet/3.1.1/klayr-core-v3.1.1-darwin-x64.tar.gz
----
--
Testnet::
+
...
[source,bash]
----
curl -o klayr-core.tar.gz https://downloads.klayr.com/klayr/testnet/3.1.1/klayr-core-v3.1.1-linux-x64.tar.gz
----
...
[source,bash]
----
curl -o klayr-core.tar.gz https://downloads.klayr.com/klayr/testnet/3.1.1/klayr-core-v3.1.1-darwin-x64.tar.gz
----
--
====
