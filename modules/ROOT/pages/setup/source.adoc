...
NOTE: The correct version for NPM v9 is installed automatically with version 18 of Node.js.
...
This section details how to install Klayr Core from Source code.
