...
:url_guides_setup_bootstrap: build-blockchain/get-started.adoc#bootstrapping-a-new-blockchain-application-with-klayr-commander
:url_commander_commands: {v_sdk}@klayr-sdk::reference/klayr-commander/commands.adoc
:url_framework_dashbobardplugin: {v_sdk}@klayr-sdk::reference/klayr-framework/dashboard-plugin.adoc
:url_elements: {v_sdk}@klayr-sdk::reference/klayr-elements/index.adoc
:url_elements_crytpography: {v_sdk}@klayr-sdk::reference/klayr-elements/cryptography.adoc
:url_explanations_consensus: {v_sdk}@klayr-sdk::reference/klayr-framework/dpos-module.adoc#forging
:url_explanations_consensus_register: {v_sdk}@klayr-sdk::reference/klayr-framework/dpos-module.adoc#delegate_registration
:url_references_cli_forgingconfig: {v_sdk}@klayr-sdk::reference/application-cli.adoc#forgingconfig
:url_references_cli_forgingenable: {v_sdk}@klayr-sdk::reference/application-cli.adoc#forgingenable
...
There are many possibilities to post the transaction, use the one you prefer: {url_klayr_wallet}[Klayr Desktop^], xref:{url_elements}[Klayr Elements], or the xref:{url_framework_dashbobardplugin}[].
...
+
--
If the blockchain application was xref:{url_guides_setup_bootstrap}[bootstrapepd with Klayr Commander], it is possible to generate the relevant forging data conveniently with the command xref:{url_references_cli_forgingconfig}[forging:config].
...
----
--
Option B - Creating the data with Klayr Commander::
+
--
Please ensure the xref:{url_commander_commands}[Klayr Commander] is installed in a secure environment.
...
+
--
If the blockchain application was xref:{url_guides_setup_bootstrap}[bootstrapped with Klayr Commander], it is possible to generate the relevant forging data conveniently with the command xref:{url_references_cli_forgingenable}[forging:enable].
