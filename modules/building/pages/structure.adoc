...
:url_docs_staging: https://stagingklayr.xyz/documentation
...
* Task for deploying the latest docs on staging.klayr.xyz: {url_jenkins_staging}[^]
...
==== Deployment
* Task for compiling a new version of the Klayr documentation: {url_jenkins_build}[^]
* Task for deploying the latest docs on staging.klayr.xyz: {url_jenkins_production}[^]
