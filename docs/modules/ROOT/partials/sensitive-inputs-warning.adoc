[IMPORTANT]
====
*Important:* As the secret passphrase is a sensitive input, it can be provided using one of the methods described in the xref:references/klayr.xyzmander/sensitive-inputs.adoc[Sensitive Inputs section].
