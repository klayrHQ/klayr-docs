...
:url_typedoc_command_registervalidator: {site-url}/klayr-sdk/v6/references/typedoc/classes/klayr_framework.ValidatorRegistrationCommand.html
:url_typedoc_command_registersc: {site-url}/klayr-sdk/v6/references/typedoc/classes/klayr_framework.RegisterSidechainCommand.html
:url_typedoc_command_transfer: {site-url}/klayr-sdk/v6/references/typedoc/classes/klayr_framework.TransferCommand.html
// Project URLs
...
+
----
10^7^ Beddows or 0.1 KLY = 1000 * (100000000 / 10000) = 1000 * 10000
----
...
+
----
90.9 * 10^8^ Beddows or 90.9 KLY = 10100000000 - (101 * 10000000) = 101 * 10^8 - 101 * 10^7^
----
...
----
+
For the Klayr mainchain, the default reward for standby validators is: 10^8^ Beddows or 1 KLY.
...
Currently, in the Klayr mainchain, the inflation is limited to a maximum minting of `6 * 60 * 24 * 365 = 3153600 KLY` per year.
