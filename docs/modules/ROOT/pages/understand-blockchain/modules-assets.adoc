...
// URLs
:url_github_hello_module: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/hello-world/blockchain_app/hello_module/hello_module.js
:url_github_nft_module: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/tutorials/nft/blockchain_app/nft_module/index.js
...
:url_protocol_accounts: understand-blockchain/klayr-protocol/accounts.adoc
:url_protocol_accounts_delegate: understand-blockchain/klayr-protocol/transactions.adoc#delegate
:url_protocol_accounts_multisignature: understand-blockchain/klayr-protocol/transactions.adoc#multisignature
:url_protocol_accounts_transfer: understand-blockchain/klayr-protocol/transactions.adoc#transfer
:url_protocol_accounts_unlock: understand-blockchain/klayr-protocol/transactions.adoc#unlock
:url_protocol_accounts_vote: understand-blockchain/klayr-protocol/transactions.adoc#vote
:url_protocol_accounts_pom: understand-blockchain/klayr-protocol/transactions.adoc#pom
...
If the application was xref:{url_guides_setup}[bootstrapped] with Klayr Commander, they are registered in the file `src/app/modules.ts`.
...
The module IDs `0`-`999` are reserved for official modules for the Klayr SDK.
...
It is used as a prefix in the xref:{url_advanced_communication_alias}[alias] of events and actions, and as a key label to add the properties of the <<account-schema>> to the user accounts footnote:account_footnote[For more information about accounts, check the xref:{url_protocol_accounts}[] page of the Klayr protocol.].
