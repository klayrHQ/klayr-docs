...
// Project URLs
:url_introduction_modules_accountschema: understand-blockchain/modules-assets.adoc#account-schema
:url_introduction_modules_assetschema: understand-blockchain/modules-assets.adoc#transaction-asset-schema
:url_guides_decode: integrate-blockchain/encode-decode.adoc

Schemas are used in various places in the Klayr SDK to encode and decode the data that is retrieved or pushed to the database.
