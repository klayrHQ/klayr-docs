...
:url_statestore: v5@klayr-sdk::references/klayr-elements/chain.adoc#state-store
:url_references_token_module: v5@klayr-sdk::modules/token-module.adoc
...
First, create the folder for the blockchain application, initialize a new Node.js project and install the xref:{url_klayr_sdk}[Klayr SDK] as a dependency.
