...
// :url_statestore: klayr-sdk::references/klayr-elements/chain.adoc#state-store
...
First, create the folder for the blockchain application, initialize a new Node.js project and install the Klayr SDK as a dependency.
...
* `stateStore`: The state store is a data structure that maintains a temporary state while processing a block.
