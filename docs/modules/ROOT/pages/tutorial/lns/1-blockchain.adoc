...
:url_guide_setup_dependencies: build-blockchain/create-blockchain-client.adoc#dependencies
:url_guide_setup_init: build-blockchain/create-blockchain-client.adoc#initializing-a-new-blockchain-client
:url_guide_genesisblock: build-blockchain/create-genesis-block.adoc
// :url_reference_dashboard: klayr-sdk::plugins/dashboard-plugin.adoc
// :url_reference_faucet: klayr-sdk::plugins/faucet-plugin.adoc
:sectnums:
...
This describes in a straightforward manner, which data is expected to be in the transaction asset for the successful registration of a new domain.
