...
// Project URLs
:url_build_bapp: build-blockchain/create-blockchain-app.adoc#bootstrapping-a-new-blockchain-application-with-klayr-commander
...
The minimum value for it is `1000`, as the other IDs are reserved for future default modules of the xref:{url_klayr_sdk}[Klayr SDK].
