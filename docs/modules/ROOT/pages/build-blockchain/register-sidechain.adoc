...
:url_bls_key: https://github.com/KlayrHQ/lips/blob/main/proposals/lip-0038.md#public-key-registration-and-proof-of-possession
:url_lip56: https://github.com/KlayrHQ/lips/blob/main/proposals/lip-0056.md
:url_lip56_bftweight: {url_lip56}#terminology
:url_github_sdk_interop: https://github.com/KlayrHQ/klayr-sdk/blob/development/examples/interop
...
:url_github_sdk_cctransfer: {url_github_sdk_interop}/pos-mainchain-fast/config/scripts/transfer_kly_sidechain_one.ts
:url_github_appregistry: https://github.com/KlayrHQ/app-registry
:url_github_appregistry_readme: {url_github_appregistry}#klayr-application-registry
...
:url_update_cross_chain_lip53: https://github.com/KlayrHQ/lips/blob/main/proposals/lip-0053.md#outboxrootwitness
:url_exmaples_guides_createparams: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/guides/chain-registration/mainchain/paramsCreation.ts
:url_exmaples_guides_validatorsignatures: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/guides/chain-registration/mainchain/validatorSignatures.ts
:url_exmaples_guides_mcregistration: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/guides/chain-registration/mainchain/mainchainRegistration.ts
:url_github_exmaples_sidechaintegistration: https://github.com/KlayrHQ/klayr-sdk-examples/blob/development/guides/chain-registration/sidechain/sidechainRegistration.ts
// Project URLs
...
:url_api_rpc_getnodeinfo: api/klayr-node-rpc.adoc#system_getnodeinfo
:url_api_rpc_bftparams: api/klayr-node-rpc.adoc#consensus_getbftparameters
...
A Sidechain Registration transaction *can be sent by any user account on the Klayr Mainchain* that has adequate funds to pay the required <<sidechain-registration-fee,fee>>.
...
NOTE: The process of registering a sidechain on the mainchain is explained by following the existing example {url_github_sdk_scregistration}[sidechain_registration.ts^], which can be found in the {url_github_sdk_interop}[interoperability example^] in the Klayr SDK repository.
...
NOTE: The extra registration fee for a sidechain registration is *10 KLY* tokens.
...
Has to be *unique* within the Klayr ecosystem.
...
NOTE: The process of registering the mainchain on a sidechain is explained by following the existing example {url_github_sdk_mcregistration}[mainchain_registration.ts^], which can be found in the Klayr SDK repository.
...
`app.json`::
Off-chain metadata of a sidechain, to be used by client applications such as Klayr Desktop, Mobile and other explorers.
...
----
{
    ...
    "chainID": "02000000",
    "networkType": "betanet",
    "genesisURL": "https://downloads.klayr.com/klayr/betanet/genesis_block.json.tar.gz",
    ...
    "serviceURLs": [
        {
            "http": "https://betanet-service.klayr.com",
            "ws": "wss://betanet-service.klayr.com"
        }
    ],
    "explorers": [
        {
    ...
    "appNodes": [
        {
            "url": "https://betanet.klayr.com",
            "maintainer": "Lightcurve GmbH"
        },
        {
            "url": "wss://betanet.klayr.com",
            "maintainer": "Lightcurve GmbH"
        }
    ]
}
...
=== Move KLY to sidechain

NOTE: This step is not necessary, if the default token for the CCM fees (KLY) is changed to a native sidechain token.
...
* `tokenID`: The token ID of the KLY token.
* `receivingChainID`: Enter the chain ID of the respective sidechain where you intend to transfer your KLY tokens.
...
Enter here the tokenID of the KLY token.
...
[TIP]
====
Alternatively, the following script can be used to perform the cross-chain transfer: {url_github_sdk_cctransfer}[transfer_kly_sidechain_one.ts^]
...
[source,bash]
----
ts-node pos-mainchain-fast/config/scripts/transfer_kly_sidechain_one.ts
----
====
