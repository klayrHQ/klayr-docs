...
It can be imported directly from the `klayr-sdk` package, or alternatively it can be installed as a separate package `@klayr/genesis`.

[source,bash]
----
npm install klayr-sdk
# or
npm install @klayr/genesis
----
