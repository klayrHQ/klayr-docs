...
:url_genesis_block: understand-blockchain/architecture.adoc#genesis-block
...
----
$ ./bin/run start
Starting Klayr hello_app at /Users/mona/.klayr/hello_app.
12:31:44 INFO klayr-framework: Starting the app - hello_app (module=klayr:app)
12:31:44 INFO klayr-framework: If you experience any type of error, please open an issue on Klayr GitHub: https://github.com/KlayrHQ/klayr-sdk/issues (module=klayr:app)
12:31:44 INFO klayr-framework: Contribution guidelines can be found at Klayr-sdk: https://github.com/KlayrHQ/klayr-sdk/blob/development/docs/CONTRIBUTING.md (module=klayr:app)
12:31:44 INFO klayr-framework: Booting the application with Klayr Framework(0.1.0) (module=klayr:app)
12:31:44 INFO klayr-framework: Initializing controller (module=klayr:app)
12:31:44 INFO klayr-framework: Loading controller (module=klayr:app)
12:31:44 INFO klayr-framework: Event * was subscribed but not registered to the bus yet. (module=klayr:app)
    TypeError: Cannot read property 'helloMessage' of undefined
12:31:45 INFO klayr-framework: Application shutdown started (module=klayr:app)
{
 "errorCode": 2,
...
== Manual genesis block creation (alternative with Klayr Genesis)

The `genesis` library can be used to generate a valid genesis block based on the above parameters.
It can be imported directly from the `klayr-sdk` package, or alternatively it can be installed as a separate package `@klayrhq/klayr-genesis`.

[source,bash]
----
npm install klayr-sdk
# or
npm install @klayrhq/klayr-genesis
----
...
[source,js]
----
const { TokenModule, DPoSModule, KeysModule, SequenceModule, genesis, passphrase, cryptography, configDevnet } = require('klayr-sdk');
