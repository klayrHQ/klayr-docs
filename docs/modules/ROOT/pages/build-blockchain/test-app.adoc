...
// URLs
:url_github_guides_tests: https://github.com/KlayrHQ/klayr-sdk-examples/tree/development/guides/04-plugin/hello_app/test
// Project URLs
...
How to use the test utility of the xref:{url_klayr_sdk}[Klayr SDK] to test your application.
...
import { testing, StateStore, ReducerHandler, codec } from 'klayr-sdk'; // <2>
import { HelloModule } from '../../../../../src/app/modules/hello/hello_module'; // <3>
----

<1> `CreateHelloAsset`: The asset which is tested here.
<2> The following is imported from the `klayr-sdk` package:

* `testing` contains the functions of the Klayr SDk test suite.
...
import { testing, StateStore, codec } from 'klayr-sdk'; // <3>
...
<3> The following is imported from the `klayr-sdk` package:
