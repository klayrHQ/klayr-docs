...
Now, navigate to the `hello_frontend` folder and install the `@klayrhq/klayr-client` package.
Through `klayr-client`, the UI will communicate with the *hello_client*.

[source, bash]
----
npm install @klayrhq/klayr-client --save
----
...
[source,javascript]
----
// Always use the browser version of the '@klayrhq/klayr-client' for UI projects.
import { apiClient } from '@klayrhq/klayr-client/browser'; 
