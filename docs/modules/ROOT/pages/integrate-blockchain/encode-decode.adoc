...
// URLs
:url_example_helloapp: https://github.com/KlayrHQ/klayr-sdk-examples/tree/development/guides/04-plugin/hello_app
// Project URLS
...
Blocks and transactions can be decoded conveniently with the xref:{url_references_apiclient}[apiClient] library of the Klayr SDK.
...
TIP: The `apiClient` is also included in the NPM package xref:{url_references_client}[`@klayrhq/klayr-client`].
