...
We will use the `@klayr/client` package in the frontend application to communicate with the blockchain application.
...
[source,js]
----
const { apiClient, cryptography } = require('@klayr/client');
