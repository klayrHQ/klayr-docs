...
:url_klayrobserver: https://klayr.observer/
...
For the Klayr Mainnet, this information can be obtained directly from the {url_klayr_wallet}[Klayr Desktop^], or one of the various Klayr explorers like {url_liskscan}[^] or {url_klayrobserver}[^].
