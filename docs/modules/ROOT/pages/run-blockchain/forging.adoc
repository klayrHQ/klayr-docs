...
:url_guides_setup_bootstrap: build-blockchain/create-blockchain-app.adoc#bootstrapping-a-new-blockchain-application-with-klayr.xyzmander
:url_commander_commands: {docs_sdk}references/klayr.xyzmander/commands.adoc
