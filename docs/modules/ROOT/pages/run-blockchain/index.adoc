...
:url_faucet: https://testnet-faucet.klayr.com/
...
// :url_p2p: https://klayr.com/documentation/klayr-docs/klayr-sdk/v6/references/typedoc/modules/_klayrhq_klayr_p2p.html
...
In the Klayr Mainnet, exactly 103 validators exist in the network for each block generation round.
