...
=== Access paths and compatibility
The WebSocket API can be accessed by the `wss://service.klayr.com/rpc-v2`.

The testnet network can also be accessed by `wss://testnet-service.klayr.com/rpc-v2`.

The Klayr Service WebSocket API uses the `socket.io` library and is compatible with the JSON-RPC 2.0 standard.
...
const wsRequest = async () => {
  return await request('ws://localhost:9901/rpc', 'get.accounts', { "address": "klyzkfw7ofgp3uusknbetemrey4aeatgf2ntbhcds" });
};
...
== Date Format
Contrary to the original Klayr Core API, all timestamps used by the Klayr Service are in the UNIX timestamp format.
...
[
    ...
    { "jsonrpc": "2.0", "id": 3, "method": "get.accounts", "params": { "address": "klyzkfw7ofgp3uusknbetemrey4aeatgf2ntbhcds"} }
]
----
...
|`address`
|String
|`/^kly[a-hjkm-z2-9]&#123;38&#125;$//^[1-9]\d&#123;0,19&#125;[L&#124;l]$/`
|(empty)
...
----
{
  "data": {
    ...
    "dpos": {
      ...
      "sentVotes": [
        {
          "delegateAddress": "kly24cd35u4jdq8szo3pnsqe5dsxwrnazyqqqg5eu",
          "amount": "102000000000"
        },
        {
          "delegateAddress": "kly24cd35u4jdq8szo3pnsqe5dsxwrnazyqqqg5eu",
      ...
      "unlocking": [
        {
          "delegateAddress": "klydwsyfmcko6mcd357446yatromr9vzgu7eb8y99",
          "amount": "150000000",
          "height": {
            "start": "10",
            "end": "2010"
...
.Example: Get account with a specific Klayr account ID
[source,json]
----
{
    "jsonrpc": "2.0",
    "method": "get.accounts",
    "params": {
        "address": "klyzkfw7ofgp3uusknbetemrey4aeatgf2ntbhcds"
    }
}
----
...
|`generatorAddress`
|String
|`/^kly[a-hjkm-z2-9]&#123;38&#125;$/ and /^[1-9]\d&#123;0,19&#125;[L&#124;l]$/`
|(empty)
|Resolves new and old address system.
  ...
  "data": [
    {
      ...
      "version": 0,
      "timestamp": 85944650,
      "generatorAddress": "kly24cd35u4jdq8szo3pnsqe5dsxwrnazyqqqg5eu",
...
Retrieves recent blogposts from Klayr Blog and Twitter.
...
----
{
  "data": [
    {
      "author": "Klayr",
      "content": "On Wednesday, March 3rd, Max Kordek, CEO and Co-founder at Klayr, hosted a live\nmonthly AMA (Ask Max Anything) on Klayr.chat. He answered questions regarding the\nupcoming milestones for Klayr, Klayr.js 2021, marketing plans for this year, and\nmuch more.\n\nThis blog post includes a recap of the live AMA session and features the\nquestions asked by community members, as well as Max’s answers.",
      "image_url": "https://klayr.com/sites/default/files/styles/blog_main_image_xl_retina/public/images/2021-04/montly-ama-ask-max-anything-recap-MAIN-V1%402x_0.png?itok=_0lipXxp",
      "imageUrl": "https://klayr.com/sites/default/files/styles/blog_main_image_xl_retina/public/images/2021-04/montly-ama-ask-max-anything-recap-MAIN-V1%402x_0.png?itok=_0lipXxp",
      "source": "drupal_klayr_general",
      "sourceId": "1001",
      "timestamp": 1614854580,
      "createdAt": 1614854580,
      "modifiedAt": 1614854580,
      "title": "AMA Recap: Ask Max Anything in March 2021",
      "url": "https://klayr.com/blog/events/ama-recap-ask-max-anything-march-2021"
    }
  ],
  "meta": {
    "count": 1,
