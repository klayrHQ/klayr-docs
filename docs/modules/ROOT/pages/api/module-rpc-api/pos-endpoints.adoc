...
[source,bash]
----
klayr-core endpoint:invoke pos_getStaker '{"address":"lskhf3gtj3wecxaxy7csqb5k8kszugghpscvat5b4"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke pos_getValidator '{"address":"lskhf3gtj3wecxaxy7csqb5k8kszugghpscvat5b4"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke pos_getLockedStakedAmount '{"address":"lskzytpy82c8xtkpopchzee3vydza4cvjvcsa4fv3"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke pos_getPendingUnlocks '{"address":"lskhf3gtj3wecxaxy7csqb5k8kszugghpscvat5b4"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke pos_getLockedReward '{"address":"lskhf3gtj3wecxaxy7csqb5k8kszugghpscvat5b4", "tokenID": "0200000000000000"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke pos_getClaimableRewards '{"address":"lskhf3gtj3wecxaxy7csqb5k8kszugghpscvat5b4"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke pos_getExpectedSharedRewards '{"validatorAddress": "lskhf3gtj3wecxaxy7csqb5k8kszugghpscvat5b4", "validatorReward": "500000000", "stake":"1000000000" }' --pretty
----
