...
[source,bash]
----
klayr-core endpoint:invoke random_isSeedRevealValid '{"generatorAddress":"lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y99", "seedReveal":"c0f96ff4416b6c9ff0f641527dec0a27"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke random_setHashOnion '{"address":"lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y99", "seed": "e025160dfc93688a01c96ab9f3e0a29e", "count": 1000000, "distance": 1000}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke random_getHashOnionSeeds '{"address":"lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y99"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke random_hasHashOnion '{"address":"lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y99"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke random_getHashOnionUsage '{"address":"lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y99"}' --pretty
----
...
[source,bash]
----
klayr-core endpoint:invoke random_setHashOnionUsage '{"address":"lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y99", "usedHashOnions": [{"count": 10, "height":100 }]}' --pretty
----
