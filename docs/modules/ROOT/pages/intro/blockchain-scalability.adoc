...
:url_klayr_poa: https://klayr.com/blog/posts/proof-authority-consensus-sidechains
...
Furthermore, with Klayr SDK v6 an additional consensus mechanism, Proof of Authority, (PoA) will also be supported, therefore the user will be able to choose between PoA and PoS.
...
Further information can be found here in the following Klayr blog post: {url_klayr_poa}[PoA Consensus for Sidechains^].
