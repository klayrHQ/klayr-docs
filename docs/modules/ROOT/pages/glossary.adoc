...
:url_protocol_transactions_pom: understand-blockchain/klayr-protocol/transactions.adoc#pom
...
:url_reclaim_kly: v3@klayr-core::index.adoc#kly-reclaim
...
All properties of a transaction object are described on the xref:understand-blockchain/klayr-protocol/transactions.adoc#transaction-properties[Klayr protocol > Transactions] page. The input data for the different <<module-asset, module assets>> is stored inside the <<transaction-asset>> of a transaction.
